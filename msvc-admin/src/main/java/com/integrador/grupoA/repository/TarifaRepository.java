...
public interface TarifaRepository extends JpaRepository <Tarifa, Long> {
    ...
    @Query("SELECT new com.integrador.grupoA.services.dto.tarifas.tarifaResponse.TarifaResponseDTO(t.tipo_tarifa, t.monto) FROM Tarifa t")
    List<TarifaResponseDTO> findAllTarifas();

    @Query("SELECT new com.integrador.grupoA.services.dto.tarifas.tarifaResponse.TarifaResponseDTO(t.tipo_tarifa, t.monto) FROM Tarifa t WHERE t.tipo_tarifa = :tipo_tarifa")
    TarifaResponseDTO findTarifaPorTipo(@Param("tipo_tarifa") String tipo_tarifa);

    @Query("SELECT new com.integrador.grupoA.services.dto.tarifas.tarifaResponse.TarifaResponseDTO(t.tipo_tarifa, t.monto) FROM Tarifa t WHERE t.id = :id")
